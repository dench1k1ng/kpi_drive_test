...
class _KanbanBoardScreenState extends State<KanbanBoardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          KpiColors.background, // Принудительно устанавливаем темный фон
      appBar: AppBar(
        backgroundColor: KpiColors.columnBackground,
        title: const Text(
    ...
    return Container(
      ...
      child: Theme(
        data: Theme.of(context).copyWith(
          scaffoldBackgroundColor: KpiColors.background,
          cardColor: KpiColors.cardBackground,
          canvasColor: KpiColors.background,
        ),
        child: KanbanBoard(
